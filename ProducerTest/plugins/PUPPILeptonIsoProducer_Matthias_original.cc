...
class PUPPILeptonIsoProducer_Matthias_original : public edm::EDProducer
{
    public:
        explicit PUPPILeptonIsoProducer_Matthias_original(const edm::ParameterSet&);
        ~PUPPILeptonIsoProducer_Matthias_original();
...
//
PUPPILeptonIsoProducer_Matthias_original::PUPPILeptonIsoProducer_Matthias_original(const edm::ParameterSet& iConfig):
...
PUPPILeptonIsoProducer_Matthias_original::~PUPPILeptonIsoProducer_Matthias_original()
{
}


void
PUPPILeptonIsoProducer_Matthias_original::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
PUPPILeptonIsoProducer_Matthias_original::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
PUPPILeptonIsoProducer_Matthias_original::endJob() {
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
PUPPILeptonIsoProducer_Matthias_original::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(PUPPILeptonIsoProducer_Matthias_original);
