...
DemoAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  std::cout
   ...
   // InputTag token("puppi", "PuppiWeights"); 
   ...
   //   if (puppiIsoMatthias.isValid()==0)
   //std::cout<<puppiIso.isValid()<<" "<<puppiIsoMatthias.isValid()<<" "<< puppiweights.isValid()<<" "<<leptons.size()<<std::endl;

   std::cout<<puppiIso.isValid()<<" "<<puppiIsoMatthias.isValid()<<" "<<leptons.size()<<std::endl; 
